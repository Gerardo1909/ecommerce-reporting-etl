...
class TestCSVLoaderSave:
	...
	Valida que se guarde correctamente el archivo CSV y se actualice la metadata.
	"""
	def test_save_should_create_csv_and_metadata_when_dataframe_valid(self, tmp_path: Path, sample_valid_dataframe: pd.DataFrame) -> None:
		"""
		Debe crear archivo CSV y metadata cuando el DataFrame es válido.
		"""
